...
def plot_density(ax, fig, density, eof, region=False):
...
def generate_density_map_for_eofs(eofs_path, output_directory, region=False):
    ...
    for eof_file in eof_files:
        ...
        plot_density(ax, fig, density, eof=eof_number, region=region)
...
if __name__ == "__main__":
    eofs_path = "../../Programs_and_scripts/energetic_patterns_cyclones_south_atlantic/csv_eofs_energetics_with_track/Total/track_density"
    output_directory = "figures/eof_density_maps"

    generate_density_map_for_eofs(eofs_path, output_directory)
