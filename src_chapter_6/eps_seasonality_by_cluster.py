...
#                                                                              #
#                                                         :::      ::::::::    #
#    eps_seasonality_by_cluster.py                      :+:      :+:    :+:    #
#                                                     +:+ +:+         +:+      #
#    By: daniloceano <danilo.oceano@gmail.com>      +#+  +:+       +#+         #
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/07/07 12:40:10 by daniloceano       #+#    #+#              #
#    Updated: 2024/07/07 11:04:27 by daniloceano      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def plot_seasonality(genesis_clusters):
    for cluster, dates in genesis_clusters.items():
        ...
        plt.title(f'Seasonality for {ep}', fontsize=18)

        plt.tight_layout()
        plt.savefig(f'../figures_chapter_6/lps_seasonality_{ep}.png', dpi=300)
        plt.show()
